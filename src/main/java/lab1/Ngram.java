...
public class Ngram {
    private static List<String> enlishInput = new ArrayList<>(Arrays.asList("lab1/english1.txt", "lab1/english2.txt", "lab1/english3.txt", "lab1/english4.txt"));
    private static List<String> finnishInput = new ArrayList<>(Arrays.asList("lab1/finnish1.txt", "lab1/finnish2.txt"));
    private static List<String> germanInput = new ArrayList<>(Arrays.asList("lab1/german1.txt", "lab1/german2.txt", "lab1/german3.txt", "lab1/german4.txt"));
    private static List<String> italianInput = new ArrayList<>(Arrays.asList("lab1/italian1.txt", "lab1/italian2.txt"));
    private static List<String> polishInput = new ArrayList<>(Arrays.asList("lab1/polish1.txt", "lab1/polish2.txt", "lab1/polish3.txt"));
    private static List<String> spanishInput = new ArrayList<>(Arrays.asList("lab1/spanish1.txt", "lab1/spanish2.txt"));
